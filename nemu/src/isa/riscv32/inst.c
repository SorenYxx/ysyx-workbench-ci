...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 010 ????? 11100 11", csrrs  , I, R(rd) = csr_read(imm); csr_write(imm, src1 | imm));
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , I, s->dnpc = csr_read(0x341); csr_write(0x342, 0));
