    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_ysyxSoCFull__asic__cpu__cpu__my_LSU = new VerilatedScope{this, "ysyxSoCFull.asic.cpu.cpu.my_LSU", "my_LSU", "<null>", 0, VerilatedScope::SCOPE_OTHER};
    ...
    __Vscopep_ysyxSoCFull__asic__cpu__cpu__my_LSU->varInsert("load_q", &(TOP.ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__my_LSU__DOT__load_q), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RD, 0, 0);
    __Vscopep_ysyxSoCFull__asic__cpu__cpu__my_LSU->varInsert("store_q", &(TOP.ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__my_LSU__DOT__store_q), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RD, 0, 0);
}
...
VysyxSoCFull__Syms::~VysyxSoCFull__Syms() {
    ...
    VL_DO_CLEAR(delete __Vscopep_ysyxSoCFull__asic__cpu__cpu__my_LSU, __Vscopep_ysyxSoCFull__asic__cpu__cpu__my_LSU = nullptr);
