...
void Vysyx_26010027___024unit____Vdpiimwrap_ftrace_print_TOP____024unit(IData/*31:0*/ pc, IData/*31:0*/ target, IData/*31:0*/ rd, IData/*31:0*/ rs1) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_26010027___024unit____Vdpiimwrap_ftrace_print_TOP____024unit\n"); );
    // Body
    int pc__Vcvt;
    pc__Vcvt = pc;
    int target__Vcvt;
...
void Vysyx_26010027___024unit____Vdpiimwrap_pmem_read_TOP____024unit(IData/*31:0*/ raddr, IData/*31:0*/ &pmem_read__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_26010027___024unit____Vdpiimwrap_pmem_read_TOP____024unit\n"); );
    // Body
    int raddr__Vcvt;
    raddr__Vcvt = raddr;
...
void Vysyx_26010027___024unit____Vdpiimwrap_pmem_write_TOP____024unit(IData/*31:0*/ waddr, IData/*31:0*/ wdata, IData/*31:0*/ wmask) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_26010027___024unit____Vdpiimwrap_pmem_write_TOP____024unit\n"); );
    // Body
    int waddr__Vcvt;
    waddr__Vcvt = waddr;
    int wdata__Vcvt;
...
void Vysyx_26010027___024unit____Vdpiimwrap_is_illegal_inst_TOP____024unit() {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_26010027___024unit____Vdpiimwrap_is_illegal_inst_TOP____024unit\n"); );
    // Body
    is_illegal_inst();
}
...
void Vysyx_26010027___024unit____Vdpiimwrap_get_reg_TOP____024unit(IData/*31:0*/ waddr, IData/*31:0*/ r) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_26010027___024unit____Vdpiimwrap_get_reg_TOP____024unit\n"); );
    // Body
    int waddr__Vcvt;
    waddr__Vcvt = waddr;
    int r__Vcvt;
...
void Vysyx_26010027___024unit____Vdpiimwrap_get_csr_TOP____024unit(IData/*31:0*/ csr, IData/*31:0*/ data) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_26010027___024unit____Vdpiimwrap_get_csr_TOP____024unit\n"); );
    // Body
    int csr__Vcvt;
    csr__Vcvt = csr;
    int data__Vcvt;
