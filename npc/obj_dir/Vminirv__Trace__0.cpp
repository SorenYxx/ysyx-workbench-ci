...
void Vminirv___024root__trace_chg_0_sub_0(Vminirv___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[0U]))) {
        bufp->chgCData(oldp+0,(vlSelfRef.minirv__DOT__R__DOT__i),5);
    }
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[2U]))) {
        ...
        bufp->chgIData(oldp+34,(vlSelfRef.minirv__DOT__pc),32);
        bufp->chgIData(oldp+35,(vlSelfRef.minirv__DOT__imm),32);
        ...
        bufp->chgCData(oldp+38,((0x0000001fU & (vlSelfRef.minirv__DOT__inst 
                                                >> 7U))),5);
        bufp->chgCData(oldp+39,(vlSelfRef.minirv__DOT__waddr),5);
        bufp->chgCData(oldp+40,(vlSelfRef.minirv__DOT__op_type),3);
        bufp->chgBit(oldp+41,(vlSelfRef.minirv__DOT__reg_w));
        bufp->chgBit(oldp+42,(vlSelfRef.minirv__DOT__mem_w));
        bufp->chgBit(oldp+43,(vlSelfRef.minirv__DOT__mem_r));
        bufp->chgCData(oldp+44,(vlSelfRef.minirv__DOT__my_IDU__DOT__opcode),7);
        bufp->chgCData(oldp+45,(vlSelfRef.minirv__DOT__my_IDU__DOT__funct3),3);
    }
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[3U]))) {
        bufp->chgIData(oldp+46,(vlSelfRef.minirv__DOT__R__DOT__rdata1),32);
        bufp->chgIData(oldp+47,(vlSelfRef.minirv__DOT__R__DOT__rdata2),32);
        bufp->chgIData(oldp+48,(vlSelfRef.minirv__DOT__my_EXU__DOT__result),32);
        bufp->chgIData(oldp+49,(vlSelfRef.minirv__DOT__m_result),32);
        bufp->chgIData(oldp+50,(vlSelfRef.minirv__DOT__wdata),32);
    }
