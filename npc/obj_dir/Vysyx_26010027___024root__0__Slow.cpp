...
#endif
            VL_FATAL_MT("vsrc/ysyx_26010027.v", 12, "", "Settle region did not converge after 100 tries");
        }
...
VL_ATTR_COLD void Vysyx_26010027___024root___ctor_var_reset(Vysyx_26010027___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 4; ++__Vi1) {
            vlSelf->ysyx_26010027__DOT__my_icache__DOT__tag[__Vi0][__Vi1] = VL_SCOPED_RAND_RESET_I(23, __VscopeHash, 15766039916066462916ull);
        }
    }
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 4; ++__Vi1) {
    ...
    vlSelf->ysyx_26010027__DOT__my_IFU__DOT__ifu_idu_inst = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 7564899652205820034ull);
    vlSelf->ysyx_26010027__DOT__my_IFU__DOT__ifu_cpu_araddr = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 12303909816023312260ull);
    vlSelf->ysyx_26010027__DOT__my_IFU__DOT__ifu_cpu_arvalid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16194230361509828067ull);
    vlSelf->ysyx_26010027__DOT__my_IFU__DOT__ifu_cpu_rready = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3832757144385968061ull);
    ...
    vlSelf->ysyx_26010027__DOT__my_IDU__DOT__jump = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 475773856097691693ull);
    ...
    vlSelf->ysyx_26010027__DOT__my_EXU__DOT____VdfgRegularize_h52da6e6e_0_2 = 0;
    ...
    vlSelf->ysyx_26010027__DOT__my_EXU__DOT____VdfgRegularize_h52da6e6e_0_11 = 0;
    ...
    vlSelf->ysyx_26010027__DOT__my_LSU__DOT__l_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3562733243753237346ull);
    ...
    vlSelf->ysyx_26010027__DOT__my_LSU__DOT__req_store = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 688318974810248736ull);
    ...
    vlSelf->__Vdly__ysyx_26010027__DOT__my_LSU__DOT__l_valid = 0;
    vlSelf->__VdlySet__ysyx_26010027__DOT__my_icache__DOT__valid__v0 = 0;
    vlSelf->__VdlySet__ysyx_26010027__DOT__my_icache__DOT__valid__v128 = 0;
    vlSelf->__VdlySet__ysyx_26010027__DOT__my_icache__DOT__data__v128 = 0;
    vlSelf->__VdlySet__ysyx_26010027__DOT__my_icache__DOT__tag__v128 = 0;
